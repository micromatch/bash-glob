# Contributing to bash-glob

First and foremost, thank you! We appreciate that you want to contribute to bash-glob, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for bash-glob**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for bash-glob:

- star the [project](https://github.com/jonschlinkert/bash-glob)
- tweet your support for bash-glob
...
- **version**: please note the version of bash-glob are you using
...
[so]: http://stackoverflow.com/questions/tagged/bash-glob